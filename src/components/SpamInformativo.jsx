  ...
  return (
    <div className="flex flex-col flex-wrap bg-gray-900 lg:py-9 lg:flex-row ">
      <div className="flex flex-col items-center w-full text-justify text-white text lg:w-1/2">
        <h2 className="flex flex-col items-center justify-center h-20 lg:mb-5 text-3xl text-center text-transparent bg-gradient-to-r from-green-300 via-blue-500 to-[#57f857] bg-clip-text sm:text-5xl">
